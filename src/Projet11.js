...
import demoVideo from "./assets/Formation dev.mp4";
import projet4Img from "./assets/formationdev.jpg";
  ...
  const socialLinks = [
    {
      name: 'GitHub',
      icon: <Github size={24} />,
      url: 'https://github.com/kms-le-dev/formation-dev',
      color: '#333',
      hoverColor: '#000'
    },
    ...
    <div className="projet-container">
      ...
      <section id="projet-hero" className="projet-hero">
        <div className="hero-content">
          ...
          <h1 className="projet-title">une plateforme de formation</h1>
          <p className="projet-description">
            pour le développement web (« formation-dev ») — il présente probablement des cours, tutoriels ou ressources pour apprendre à coder ou se former au développement.
          </p>
        ...
        <div className="details-container">
          <div className="details-grid">
            <div className="detail-card">
              ...
              <h3>Objectif</h3>
              <p>Offrir un catalogue de cours ou ressources pour devenir développeur web.
                  Attirer des personnes souhaitant se former au dev (front-end/back-end) ou améliorer leurs compétences techniques.
                  Fournir une interface professionnelle pour crédibiliser l’offre de formation.
                  Faciliter la conversion : inscription, contact ou achat de cours.</p>
            </div>
            
            <div className="detail-card">
              <div className="card-icon">⚡</div>
              <h3>Fonctionnalités</h3>
              <p>Page d’accueil présentant le service de formation.
                Liste de modules ou cours (exemples : HTML/CSS, JavaScript, React, etc.).
                Section « À propos » / « Pourquoi nous choisir ».
                Formulaire de contact ou d’inscription à une formation.
                Design responsive, adaptation mobile + desktop.</p>
            </div>
            
            <div className="detail-card">
              <div className="card-icon">🚀</div>
              <h3>Performance</h3>
              <p>Hébergement sur Vercel → déploiement rapide, bon moyen de chargement global.
              Site relativement simple → bon potentiel de chargement rapide.
              Pour bien réussir : images optimisées, code allégé, méta-tags SEO.
              Important de vérifier l’affichage mobile, l’accessibilité, le référencement.</p>
            </div>
          </div>
      ...
      <section id="projet-social" className="projet-social">
        ...
        <div className="cta-section"> 
          <button className="cta-button secondary" onClick={() => window.open("https://formation-dev.vercel.app", "_blank")}>
