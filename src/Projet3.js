...
import demoVideo from "./assets/odholding.mp4";
import projet3Img from "./assets/odholding.PNG";
    ...
    <div className="projet-container">
      ...
      <section id="projet-hero" className="projet-hero">
        <div className="hero-content">
          ...
          <h1 className="projet-title">Site vitrine pour OD-HOLDING</h1>
          <p className="projet-description">
            un site vitrine professionnel
            Un site web qui reflète fidèlement l’identité visuelle de votre entreprise et vous aide à vous démarquer de la concurrence.
          </p>
        ...
        <div className="details-container">
          <div className="details-grid">
            <div className="detail-card">
              ...
              <h3>Objectif</h3>
              <p>Créer un site vitrine professionnel qui incarne l’identité visuelle de l’entreprise, renforce sa crédibilité en ligne et lui permet de se distinguer efficacement de la concurrence.</p>
            </div>
            
            <div className="detail-card">
              <div className="card-icon">⚡</div>
              <h3>Fonctionnalités</h3>
              <p>Il présente l’entreprise, ses services, et permet aux clients de vous contacter facilement.
                 Optimisé pour le référencement, il vous aide à gagner en visibilité et en crédibilité.</p>
            </div>
            
            <div className="detail-card">
              <div className="card-icon">🚀</div>
              <h3>Performance</h3>
              <p>vous offre un site vitrine rapide, fluide et optimisé.
               Conçu pour un affichage parfait sur tous les appareils, il améliore l'expérience utilisateur.
              Un outil efficace pour renforcer votre présence en ligne et convertir vos visiteurs en clients.</p>
            </div>
          </div>
          ...
          <div className="project-stats">
            <div className="stat">
              ...
              <div className="stat-label">Semaine de développement</div>
            </div>
            <div className="stat">
        ...
        <div className="tech-container">
          ...
          <div className="tech-grid">
            ...
            <div className="tech-category">
              <h3>Frontend</h3>
              <div className="tech-items">
                <span className="tech-item react">React Js</span>
                <span className="tech-item">Tilwin Css</span>
            ...
            <div className="tech-category">
              <h3>Backend</h3>
              <div className="tech-items">
                <span className="tech-item">(pas de back, juste une API)</span>
              </div>
            </div>
      ...
      <section id="projet-social" className="projet-social">
        ...
        <div className="cta-section"> 
          <button className="cta-button secondary" onClick={() => window.open("https://od-holding.vercel.app", "_blank")}>
