...
import demoVideo from "./assets/Lesdocuments.mp4";
import projet4Img from "./assets/lesdocuments.jpg";
  ...
  const socialLinks = [
    {
      name: 'GitHub',
      icon: <Github size={24} />,
      url: 'https://github.com/kms-le-dev/lesdocuments',
      color: '#333',
      hoverColor: '#000'
    },
      ...
      <section id="projet-hero" className="projet-hero">
        <div className="hero-content">
          ...
          <p className="projet-description">
            qui semble proposer une plateforme ou un service lié aux « documents » pour la Côte d’Ivoire (CI) — peut-être un espace de consultation, de gestion ou d’archivage de documents.
          </p>
        ...
        <div className="details-container">
          <div className="details-grid">
            <div className="detail-card">
              ...
              <h3>Objectif</h3>
              <p>Mettre à disposition une interface claire pour accéder à des documents ou à un catalogue de documents destinés aux utilisateurs en Côte d’Ivoire.
                Optimiser l’accessibilité numérique des documents : consultation, téléchargement, ou information.
                Améliorer la visibilité et la crédibilité du service proposé, en simplifiant l’accès aux ressources documentaires.</p>
            </div>
            
            <div className="detail-card">
              <div className="card-icon">⚡</div>
              <h3>Fonctionnalités</h3>
              <p>Page d’accueil présentant le service ou la mission de la plateforme.
                  Navigation vers les sections « documents », « à propos », « contact ».
                  Possibilité de visualiser ou de lister des documents (ou éventuellement de les télécharger).
                  Design responsive pour usage sur mobile et ordinateur.</p>
            </div>
            
            <div className="detail-card">
              <div className="card-icon">🚀</div>
              <h3>Performance</h3>
              <p>Hébergement sur Vercel (ce qui facilite un déploiement rapide et international).
                  Structure simple, donc chargement assez rapide attendu.
                  Bonne base pour le SEO et l’affichage mobile si bien optimisé.</p>
            </div>
          </div>
