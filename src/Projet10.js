...
import demoVideo from "./assets/Fcferke.mp4";
import projet4Img from "./assets/fcferke.jpg";
  ...
  const socialLinks = [
    {
      name: 'GitHub',
      icon: <Github size={24} />,
      url: 'https://github.com/kms-le-dev/fcferke',
      color: '#333',
      hoverColor: '#000'
    },
    ...
    <div className="projet-container">
      ...
      <section id="projet-hero" className="projet-hero">
        <div className="hero-content">
          ...
          <h1 className="projet-title">Ce Site Vitrine</h1>
          <p className="projet-description">
            est une page de présentation pour FC Ferké (ou « F.C. Ferké »), probablement un club sportif ou une équipe. Il présente probablement les informations du club, ses membres, ses activités, ses événements ou résultats.
          </p>
        ...
        <div className="details-container">
          <div className="details-grid">
            <div className="detail-card">
              ...
              <h3>Objectif</h3>
              <p>Mettre en avant l’identité du club (logo, couleurs, mission) et sa visibilité en ligne.
                Informer les visiteurs : supporters, joueurs, partenaires sur les actualités, l’équipe, les matchs.
                Créer un lien de contact ou d’engagement avec la communauté (inscriptions, sponsors, supporters).
                Renforcer la crédibilité du club via une présence web professionnelle.</p>
            </div>
            
            <div className="detail-card">
              <div className="card-icon">⚡</div>
              <h3>Fonctionnalités</h3>
              <p>Une page d’accueil présentant le club, ses valeurs et visuels.
                  Une section « À propos » ou « L’équipe » avec les membres ou le staff.
                  Une section « Actualités » ou « Événements » pour les matchs ou activités du club.
                  Un formulaire de contact ou un lien pour rejoindre/supporter le club.
                  Design responsive adapté aux mobiles et ordinateurs.</p>
            </div>
            
            <div className="detail-card">
              <div className="card-icon">🚀</div>
              <h3>Performance</h3>
              <p>Hébergement sur Vercel : ça favorise un déploiement rapide et un bon temps de chargement.
                Structure simple/dirigée (vitrine) : bon potentiel pour des temps de chargement faibles.
                Pour un usage mobile et web, la performance doit être fluide (images optimisées, navigation simple).</p>
            </div>
          </div>
          ...
          <div className="project-stats">
            <div className="stat">
              ...
              <div className="stat-label">Semaines de développement</div>
            </div>
            <div className="stat">
      ...
      <section id="projet-social" className="projet-social">
        ...
        <div className="cta-section"> 
          <button className="cta-button secondary" onClick={() => window.open("https://fcferke.vercel.app", "_blank")}>
