...
import demoVideo from "./assets/etablissement.mp4";
import dashbordImg from "./assets/dashbord.webp";
    ...
    <div className="projet-container">
      ...
      <section id="projet-hero" className="projet-hero">
        <div className="hero-content">
          ...
          <h1 className="projet-title">Mini Application De Gestion d'un établissement</h1>
          <p className="projet-description">
            Conception d’un logiciel de gestion d’établissement (version “Inscription &
            Facturation”) 1.Créer la fiche d’un étudiant ;
                          2. Enregistrer une inscription ;
                          3. Émettre une facture et marquer le paiement ;
                          4. Générer un petit rapport. 
          </p>
        ...
        <div className="details-container">
          <div className="details-grid">
            <div className="detail-card">
              ...
              <h3>Objectif</h3>
              <p>Concevoir un prototype fonctionnel simple</p>
            </div>
            
            <div className="detail-card">
              <div className="card-icon">⚡</div>
              <h3>Fonctionnalités</h3>
              <p>Créer la fiche d’un étudiant ;
                 Enregistrer une inscription ;
                 Émettre une facture et marquer le paiement ;
                 Générer un petit rapport.</p>
            </div>
          ...
          <div className="project-stats">
            <div className="stat">
              ...
              <div className="stat-label">Heures de développement</div>
            </div>
            <div className="stat">
      ...
      <section id="projet-social" className="projet-social">
        ...
        <div className="cta-section"> 
          <button className="cta-button secondary" onClick={() => window.open("http://etablissement.atwebpages.com/htdocs/index.php", "_blank")}>
