...
import demoVideo from "./assets/Moinschere-ci.mp4";
import projet4Img from "./assets/moins.jpg";
  ...
  const socialLinks = [
    {
      name: 'GitHub',
      icon: <Github size={24} />,
      url : 'https://github.com/kms-le-dev/moinschere.ci',
      color: '#333',
      hoverColor: '#000'
    },
    ...
    <div className="projet-container">
      ...
      <section id="projet-hero" className="projet-hero">
        <div className="hero-content">
          ...
          <h1 className="projet-title">Le site est une vitrine en ligne</h1>
          <p className="projet-description">
            qui propose des offres “moins chères” pour des produits ou services en Côte d’Ivoire : l’idée étant de mettre en avant des tarifs avantageux ou des remises.
          </p>
        ...
        <div className="details-container">
          <div className="details-grid">
            <div className="detail-card">
              ...
              <h3>Objectif</h3>
              <p>Attirer des visiteurs à la recherche de bons plans ou de produits/services à prix réduit.
                  Mettre en valeur la proposition “meilleur tarif” pour se différencier de la concurrence locale.
                  Générer des contacts ou des conversions (inscriptions, demandes, achats) via l’offre “moins chère”.</p>
            </div>
            
            <div className="detail-card">
              <div className="card-icon">⚡</div>
              <h3>Fonctionnalités</h3>
              <p>Page d’accueil présentant les offres ou la promesse de “tarifs réduits”.
                Sections “À propos” / “Services” qui expliquent ce que propose le site.
                Catalogue d’offres ou liste de produits/services à tarif avantageux.
                Formulaire de contact ou bouton d’appel à l’action (ex : “Demandez votre devis”, “Achetez ici”).
                Interface responsive pour usage mobile et desktop.</p>
            </div>
            
            <div className="detail-card">
              <div className="card-icon">🚀</div>
              <h3>Performance</h3>
              <p>Hébergement sur Vercel (ce qui favorise un déploiement rapide et une bonne distribution via CDN).
                Structure relativement simple donc potentiel bon temps de chargement si bien optimisée.
                Bonne base pour un référencement en Côte d’Ivoire, mais dépend de l’optimisation SEO (balises, contenu, vitesse).</p>
            </div>
          </div>
      ...
      <section id="projet-social" className="projet-social">
        ...
        <div className="cta-section"> 
          <button className="cta-button secondary" onClick={() => window.open("https://moinschere-ci.vercel.app", "_blank")}>
