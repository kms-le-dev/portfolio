...
import demoVideo from "./assets/Ledeveloppeur.mp4";
import projet4Img from "./assets/ledeveloppeur.jpg";
  ...
  const socialLinks = [
    {
      name: 'GitHub',
      icon: <Github size={24} />,
      url: 'https://github.com/kms-le-dev/ledeveloppeur',
      color: '#333',
      hoverColor: '#000'
    },
    ...
    <div className="projet-container">
      ...
      <section id="projet-hero" className="projet-hero">
        <div className="hero-content">
          ...
          <h1 className="projet-title">Le Site Web Ledeveloppeur.com</h1>
          <p className="projet-description">
            est une plateforme web professionnelle qui présente les activités de l’entreprise 
            spécialisée en développement web, services numériques, et solutions IT.
          </p>
        ...
        <div className="details-container">
          <div className="details-grid">
            <div className="detail-card">
              ...
              <h3>Objectif</h3>
              <p>Mettre en avant les compétences, réalisations et services proposés.
                 Attirer des clients / projets en tant que développeur ou agence digitale.
                 Créer une présence en ligne soignée et crédible dans le domaine tech.</p>
            </div>
            
            <div className="detail-card">
              <div className="card-icon">⚡</div>
              <h3>Fonctionnalités</h3>
              <p>Page d’accueil avec aperçu des services et du portfolio.
                  Section “À propos” présentant l’équipe ou le développeur.
                  Section “Services” listant ce qui est proposé (développement web, mobile, etc.).
                  Contact / formulaire pour prise de rendez-vous ou demande de devis.
                  Design responsive adapté aux écrans mobiles & desktop.</p>
            </div>
            
            <div className="detail-card">
              <div className="card-icon">🚀</div>
              <h3>Performance</h3>
              <p>Hébergement sur Vercel, ce qui facilite un déploiement rapide et global.
                Chargement optimisé (assets statiques, CDN) pour une expérience fluide.
                Structure moderne permettant un bon référencement et adaptabilité mobile.</p>
            </div>
          </div>
      ...
      <section id="projet-social" className="projet-social">
        ...
        <div className="cta-section"> 
          <button className="cta-button secondary" onClick={() => window.open("https://le-dev-sigma.vercel.app", "_blank")}>
